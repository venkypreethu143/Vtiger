...
public class WebDriverLibrary {
   ...
   /**
    * This method will switch from parent window to Child window and viceversa
    * @param driver
   ...
   public String takeScreenShot(WebDriver driver, String screenshotName) throws IOException {
	   ...
	   return dst.getAbsolutePath(); //used for extend reports
   }
   
   /**
    * This method will scroll the webpage for 500 pixels Down (Vertically)
    * @param driver
    */
